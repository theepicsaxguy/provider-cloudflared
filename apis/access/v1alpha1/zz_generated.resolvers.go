...
func (mg *CACertificate) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: ptr.Deref(mg.Spec.ForProvider.ApplicationID, ""),
		Extract:      reference.ExternalName(),
	...
	mg.Spec.ForProvider.ApplicationID = ptr.To(rsp.ResolvedValue)
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		CurrentValue: ptr.Deref(mg.Spec.InitProvider.ApplicationID, ""),
		Extract:      reference.ExternalName(),
	...
	mg.Spec.InitProvider.ApplicationID = ptr.To(rsp.ResolvedValue)
